...
namespace OctoAwesome
{
    ...
    public class ComponentList<T> : IEnumerable<T> where T : Component, ISerializable
    {
        ...
        public T this[Type type] => _components.TryGetValue(type, out var result) ? result : null;
        ...
        public virtual void Serialize(BinaryWriter writer)
        {
            ...
            foreach (var componente in _components)
            {
        ...
        public virtual void Deserialize(BinaryReader reader)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                if (!_components.TryGetValue(type, out T component))
                {
