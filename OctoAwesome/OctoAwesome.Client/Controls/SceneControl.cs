...
namespace OctoAwesome.Client.Controls
{
    internal sealed class SceneControl : Control, IDisposable
    {
        ...
        private readonly ushort[] _selectionIndices =
        {
            0, 1, 0, 2, 1, 3, 2, 3,
            4, 5, 4, 6, 5, 7, 6, 7,
            0, 4, 1, 5, 2, 6, 3, 7
        ...
        private readonly ConcurrentQueue<ChunkRenderer> _forcedRenders = new ConcurrentQueue<ChunkRenderer>();
            ...
            for (var z = -Player.SELECTIONRANGE; z < Player.SELECTIONRANGE; z++)
            {
                for (var y = -Player.SELECTIONRANGE; y < Player.SELECTIONRANGE; y++)
                {
                    for (var x = -Player.SELECTIONRANGE; x < Player.SELECTIONRANGE; x++)
                    {
                        ...
                        var distance =
                            Block.Intersect(blockDefinition.GetCollisionBoxes(_localChunkCache, pos.X, pos.Y, pos.Z),
