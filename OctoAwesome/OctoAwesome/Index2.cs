...
namespace OctoAwesome
{
    ...
    public struct Index2 : IEquatable<Index2>
    {
        ...
        /// <returns></returns>
        public static Index2 operator +(Index2 i1, Index2 i2) => new(i1.X + i2.X, i1.Y + i2.Y);
        ...
        /// <returns></returns>
        public static Index2 operator *(Index2 i1, int scale) => new(i1.X * scale, i1.Y * scale);
        ...
        public static implicit operator Vector2(Index2 index) => new(index.X, index.Y);
        ...
        public bool Equals(Index2 other) => other.X == X && other.Y == Y;

        /// <summary>
        ///     Null-Index
        /// </summary>
        public static Index2 Zero => new(0, 0);

        /// <summary>
        ///     Index(1,1)
        /// </summary>
        public static Index2 One => new(1, 1);

        /// <summary>
        ///     Einheitsindex für X
        /// </summary>
        public static Index2 UnitX => new(1, 0);

        /// <summary>
        ///     Einheitsindex für Y
        /// </summary>
        public static Index2 UnitY => new(0, 1);
    }
}