...
namespace OctoAwesome.Client.Components.Hud
{
    internal class InventoryScreen : Screen
    {
        ...
        public InventoryScreen(IScreenManager screenManager, PlayerComponent player) : base(screenManager)
        {
            this.player = player;
        }
        ...
        public override void LoadContent()
        {
            ...
            panel.Position = new Index2((ScreenManager.ScreenSize.X - 600) / 2, (ScreenManager.ScreenSize.Y - 400) / 2);
            ...
            headline = new LabelControl(ScreenManager)
            {
                ...
                Text = "Inventory",
                Color = Color.Black,
                Position = new Index2(((ScreenManager.ScreenSize.X - 600) / 2) + 100, ((ScreenManager.ScreenSize.Y - 400) / 2) + 40)
            };
            ...
            counter = new LabelControl(ScreenManager)
            {
                Font = ScreenManager.NormalText,
                Color = Color.Black,
                Position = new Index2(((ScreenManager.ScreenSize.X - 600) / 2) + 100, ((ScreenManager.ScreenSize.Y - 400) / 2) + 140)
            };
