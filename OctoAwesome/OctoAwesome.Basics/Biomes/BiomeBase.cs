...
namespace OctoAwesome.Basics.Biomes
{
    public abstract class BiomeBase : IBiome
    {
        ...
        public virtual float[,] GetHeightmap(Index2 chunkIndex)
        {
            ...
            var heights = BiomeNoiseGenerator.GetTileableNoiseMap2D(chunkIndex.X, chunkIndex.Y, Chunk.CHUNKSIZE_X, Chunk.CHUNKSIZE_Y, Planet.Size.X * Chunk.CHUNKSIZE_X, Planet.Size.Y * Chunk.CHUNKSIZE_Y);
