        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            foreach (var item in game.Map.Items.OrderBy(t => t.Position.Y))
            {
                ...
                if (item is Player)
                {
                    ...
                    e.Graphics.DrawImage(sprite, new RectangleF((game.Player.Position.X * game.Camera.SCALE) - game.Camera.ViewPort.X - spriteCenter.X, 
                        (game.Player.Position.Y * game.Camera.SCALE) - game.Camera.ViewPort.Y - spriteCenter.Y, SPRITE_WIDTH, SPRITE_HEIGHT),
                        new RectangleF(offsetx, offsety, SPRITE_WIDTH, SPRITE_HEIGHT), GraphicsUnit.Pixel);
                }
            }
        }
    }
