...
namespace OctoAwesome
{
    public static class TypeContainer
    {
        ...
        public static void Register(Type registrar, Type type, object singleton) => _instance.Register(registrar, type, singleton);

        public static void Register<T>(T singleton) where T : class => _instance.Register(singleton);
