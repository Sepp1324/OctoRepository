...
namespace OctoAwesome.Database
{
    ...
    public sealed class Database<TTag> : Database where TTag : ITag, new()
    {
        ...
        {
            _dbLockSemaphore = new SemaphoreSlim(1, 1);
            _databaseLockMonitor = new DatabaseLockMonitor();
        ...
        private bool FixedValueLength => _valueStore.FixedValueLength;
        ...
        {
            ExecuteOperationOnKeyValueStore(_checkFunc);
        }

        private void Defragmentation() => ExecuteOperationOnKeyValueStore(_startDefragFunc);
