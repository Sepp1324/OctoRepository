...
namespace OctoAwesome
{
    public static class TypeContainer
    {
        ...
        public static void Register(Type registrar, Type type, object singleton) => instance.Register(registrar, type, singleton); public static void Register<T>(T singelton) where T : class => instance.Register(singelton);
