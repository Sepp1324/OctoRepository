...
namespace OctoAwesome
{
    ...
    public struct Index3 : IEquatable<Index3>
    {
        ...
        /// <param name="size">Normalisierungsgröße</param>
        /// <returns>Entfernung</returns>
        public Index3 ShortestDistanceXY(Index3 destination, Index3 size) => new Index3(ShortestDistanceX(destination.X, size.X), ShortestDistanceY(destination.Y, size.Y), destination.Z - Z);
        ...
        /// <param name="size">Normalisierungsgröße</param>
        /// <returns>Entfernung</returns>
        public Index3 ShortestDistanceXY(Index3 destination, Index2 size) => new Index3(ShortestDistanceX(destination.X, size.X), ShortestDistanceY(destination.Y, size.Y), destination.Z - Z);
        ...
        /// <param name="size">Normalisierungsgröße</param>
        /// <returns>Entfernung</returns>
        public Index3 ShortestDistanceXYZ(Index3 destination, Index3 size) => new Index3(ShortestDistanceX(destination.X, size.X), ShortestDistanceY(destination.Y, size.Y), ShortestDistanceZ(destination.Z, size.Z));
        ...
        public bool Equals(Index3 other) => X == other.X && Y == other.Y && Z == other.Z;
