...
namespace OctoAwesome.Client.Controls
{
    internal sealed class SceneControl : Control, IDisposable
    {
            ...
            base(manager, style)
        {
            ...
            {
                var renderer = new ChunkRenderer(this, Manager.Game.DefinitionManager, _simpleShader,
                    manager.GraphicsDevice, _camera.Projection, _blockTextures);
            ...
            _selectionLines = new VertexBuffer(manager.GraphicsDevice, VertexPositionColor.VertexDeclaration,
                selectionVertices.Length);
            _selectionLines.SetData(selectionVertices);

            _selectionIndexBuffer = new IndexBuffer(manager.GraphicsDevice, DrawElementsType.UnsignedShort,
        ...
        protected override void OnUpdate(GameTime gameTime)
        {
            ...
            for (var x = -Player.SELECTIONRANGE; x < Player.SELECTIONRANGE; x++)
            {
                ...
                var blockDefinition = Manager.Game.DefinitionManager.GetBlockDefinitionByIndex(block);

                var distance = Block.Intersect(blockDefinition.GetCollisionBoxes(_localChunkCache, pos.X, pos.Y, pos.Z),
                    pos - renderOffset, _camera.PickRay, out var collisionAxis);
            ...
            if (selected.HasValue)
            {
                ...
                switch (_player.SelectedSide)
                {
                    case OrientationFlags.SideWest:
                        ...
                        _player.SelectedCorner = FindCorner(_player.SelectedPoint.Value, OrientationFlags.Corner011,
                            OrientationFlags.Corner001, OrientationFlags.Corner010, OrientationFlags.Corner000);
                        _player.SelectedEdge = FindEdge(_player.SelectedPoint.Value, OrientationFlags.EdgeWestTop,
                    ...
                    case OrientationFlags.SideEast:
                        ...
                        _player.SelectedCorner = FindCorner(_player.SelectedPoint.Value, OrientationFlags.Corner101,
                            OrientationFlags.Corner111, OrientationFlags.Corner100, OrientationFlags.Corner110);
                        _player.SelectedEdge = FindEdge(_player.SelectedPoint.Value, OrientationFlags.EdgeEastTop,
                    ...
                    case OrientationFlags.SideTop:
                        ...
                        _player.SelectedEdge = FindEdge(_player.SelectedPoint.Value, OrientationFlags.EdgeNorthTop,
                    ...
                    case OrientationFlags.SideBottom:
                        ...
                        _player.SelectedCorner = FindCorner(_player.SelectedPoint.Value, OrientationFlags.Corner000,
                            OrientationFlags.Corner100, OrientationFlags.Corner010, OrientationFlags.Corner110);
                        _player.SelectedEdge = FindEdge(_player.SelectedPoint.Value, OrientationFlags.EdgeSouthBottom,
                    ...
                    case OrientationFlags.SideNorth:
                        ...
                        _player.SelectedCorner = FindCorner(_player.SelectedPoint.Value, OrientationFlags.Corner111,
                    ...
                    case OrientationFlags.SideSouth:
                        ...
                        _player.SelectedCorner = FindCorner(_player.SelectedPoint.Value, OrientationFlags.Corner001,
                            OrientationFlags.Corner101, OrientationFlags.Corner000, OrientationFlags.Corner100);
                        _player.SelectedEdge = FindEdge(_player.SelectedPoint.Value, OrientationFlags.EdgeSouthTop,
        ...
        protected override void OnPreDraw(GameTime gameTime)
        {
            ...
            var playerPosX = _player.Position.Position.GlobalPosition.X / (_planet.Size.X * Chunk.CHUNKSIZE_X) *
                             MathHelper.TwoPi;
            var playerPosY = _player.Position.Position.GlobalPosition.Y / (_planet.Size.Y * Chunk.CHUNKSIZE_Y) *
                             MathHelper.TwoPi;
