...
namespace OctoAwesome.Tests
{
    ...
    public class CoordinateTests
    {
        ...
        public void CoordinateConstructorTests()
        {
            ...
            AssertEx.AreEqual(new Vector3(0.3f, 0.4f, 0.5f), c3.BlockPosition);
            Assert.AreEqual(new Index3(1, 2, 10), c3.ChunkIndex);
            Assert.AreEqual(new Index3(45, 93, 321), c3.GlobalBlockIndex);
            AssertEx.AreEqual(new Vector3(45.3f, 93.4f, 321.5f), c3.GlobalPosition);
            Assert.AreEqual(new Index3(13, 29, 1), c3.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(13.3f, 29.4f, 1.5f), c3.LocalPosition);
        }
        ...
        public void CoordinateChunkSetter()
        {
            ...
            Assert.AreEqual(0, c.Planet);
            AssertEx.AreEqual(Vector3.Zero, c.BlockPosition);
            Assert.AreEqual(Index3.One, c.ChunkIndex);
            Assert.AreEqual(new Index3(32, 32, 32), c.GlobalBlockIndex);
            AssertEx.AreEqual(new Vector3(32, 32, 32), c.GlobalPosition);
            Assert.AreEqual(Index3.Zero, c.LocalBlockIndex);
            AssertEx.AreEqual(Vector3.Zero, c.LocalPosition);
            ...
            Assert.AreEqual(0, c.Planet);
            AssertEx.AreEqual(new Vector3(0.5f, 0.5f, 0.5f), c.BlockPosition);
            Assert.AreEqual(new Index3(100, 100, 100), c.ChunkIndex);
            Assert.AreEqual(new Index3(3216, 3216, 3216), c.GlobalBlockIndex);
            AssertEx.AreEqual(new Vector3(3216.5f, 3216.5f, 3216.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(16, 16, 16), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(16.5f, 16.5f, 16.5f), c.LocalPosition);
            ...
            Assert.AreEqual(0, c.Planet);
            AssertEx.AreEqual(new Vector3(0.3f, 0.4f, 0.5f), c.BlockPosition);
            Assert.AreEqual(new Index3(-1, -2, -3), c.ChunkIndex);
            Assert.AreEqual(new Index3(-20, -51, -82), c.GlobalBlockIndex);
            AssertEx.AreEqual(new Vector3(-19.7f, -50.6f, -81.5f), c.GlobalPosition);
        ...
        public void CoordinateLocalBlockSetter()
        {
            ...
            AssertEx.AreEqual(new Vector3(12, 13, 14), c.GlobalPosition);
            Assert.AreEqual(new Index3(12, 13, 14), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(12, 13, 14), c.LocalPosition);
            ...
            Assert.AreEqual(new Index3(76, 109, 142), c.GlobalBlockIndex);
            ...
            AssertEx.AreEqual(new Vector3(106.3f, 139.4f, 172.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(10, 11, 12), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(10.3f, 11.4f, 12.5f), c.LocalPosition);
            ...
            AssertEx.AreEqual(new Vector3(54.3f, 85.4f, 116.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(22, 21, 20), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(22.3f, 21.4f, 20.5f), c.LocalPosition);
        }
        ...
        public void CoordinateGlobalBlockGetterSetter()
        {
            ...
            Assert.AreEqual(new Index3(12, 13, 14), c.GlobalBlockIndex);
            AssertEx.AreEqual(new Vector3(12.3f, 13.4f, 14.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(12, 13, 14), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(12.3f, 13.4f, 14.5f), c.LocalPosition);
        ...
        public void CoordinateBlockPositionSetter()
        {
            ...
            AssertEx.AreEqual(new Vector3(0.3f, 0.4f, 0.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(0, 0, 0), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(0.3f, 0.4f, 0.5f), c.LocalPosition);
            ...
            AssertEx.AreEqual(new Vector3(0.3f, 0.4f, 0.5f), c.BlockPosition);
            Assert.AreEqual(new Index3(2, 3, 4), c.ChunkIndex);
            Assert.AreEqual(new Index3(78, 112, 146), c.GlobalBlockIndex);
            ...
            c.BlockPosition = new Vector3(-2.3f, -3.4f, -4.5f);
            Assert.AreEqual(42, c.Planet);
            AssertEx.AreEqual(new Vector3(0.7f, 0.6f, 0.5f), c.BlockPosition);
            Assert.AreEqual(new Index3(2, 3, 4), c.ChunkIndex);
            Assert.AreEqual(new Index3(73, 105, 137), c.GlobalBlockIndex);
            AssertEx.AreEqual(new Vector3(73.7f, 105.6f, 137.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(9, 9, 9), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(9.7f, 9.6f, 9.5f), c.LocalPosition);
            ...
            AssertEx.AreEqual(new Vector3(-68.3f, -68.4f, -68.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(27, 27, 27), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(27.7f, 27.6f, 27.5f), c.LocalPosition);
        ...
        public void CoordinateLocalPositionSetter()
        {
            ...
            AssertEx.AreEqual(new Vector3(6.3f, 7.4f, 8.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(6, 7, 8), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(6.3f, 7.4f, 8.5f), c.LocalPosition);
            ...
            AssertEx.AreEqual(new Vector3(0.3f, 0.4f, 0.5f), c.BlockPosition);
            Assert.AreEqual(new Index3(2, 3, 4), c.ChunkIndex);
            Assert.AreEqual(new Index3(70, 103, 136), c.GlobalBlockIndex);
            AssertEx.AreEqual(new Vector3(70.3f, 103.4f, 136.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(6, 7, 8), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(6.3f, 7.4f, 8.5f), c.LocalPosition);
            ...
            AssertEx.AreEqual(new Vector3(0.3f, 0.4f, 0.5f), c.BlockPosition);
            Assert.AreEqual(new Index3(3, 4, 5), c.ChunkIndex);
            Assert.AreEqual(new Index3(110, 143, 176), c.GlobalBlockIndex);
            AssertEx.AreEqual(new Vector3(110.3f, 143.4f, 176.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(14, 15, 16), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(14.3f, 15.4f, 16.5f), c.LocalPosition);
            ...
            AssertEx.AreEqual(new Vector3(47.7f, 78.6f, 109.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(15, 14, 13), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(15.7f, 14.6f, 13.5f), c.LocalPosition);
            ...
            AssertEx.AreEqual(new Vector3(-64.3f, -55.4f, -36.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(31, 8, 27), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(31.7f, 8.6f, 27.5f), c.LocalPosition);
        }
        ...
        public void CoordinateGlobalPositionSetter()
        {
            ...
            Assert.AreEqual(0, c.Planet);
            AssertEx.AreEqual(new Vector3(0.3f, 0.4f, 0.5f), c.BlockPosition);
            Assert.AreEqual(new Index3(3, 1, 0), c.ChunkIndex);
            Assert.AreEqual(new Index3(106, 47, 18), c.GlobalBlockIndex);
            AssertEx.AreEqual(new Vector3(106.3f, 47.4f, 18.5f), c.GlobalPosition);
            Assert.AreEqual(new Index3(10, 15, 18), c.LocalBlockIndex);
            AssertEx.AreEqual(new Vector3(10.3f, 15.4f, 18.5f), c.LocalPosition);
        }
