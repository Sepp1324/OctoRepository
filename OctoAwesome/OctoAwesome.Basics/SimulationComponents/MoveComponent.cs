...
namespace OctoAwesome.Basics.SimulationComponents
{
    ...
    public sealed class MoveComponent : SimulationComponent<MoveableComponent, PositionComponent>
    {
        ...
        protected override void UpdateEntity(GameTime gameTime, Entity entity, MoveableComponent movecomp,
                ...
                for (var y = miny; y <= maxy && !abort; y++)
                {
                    for (var x = minx; x <= maxx && !abort; x++)
                    {
                        ...
                        foreach (var plane in planes)
                        {
                            ...
                            if (plane.BlockPlane.normal.X != 0 &&
                            ...
                            if (plane.BlockPlane.normal.Y != 0 &&
                            ...
                            if (plane.BlockPlane.normal.Z != 0 &&
