...
namespace OctoAwesome.Information
{
    public readonly struct BlockHitInformation : IEquatable<BlockHitInformation>
    {
        ...
        public bool Equals(BlockHitInformation other) => IsHitValid == other.IsHitValid && Quantity == other.Quantity && EqualityComparer<(int Quantity, IDefinition Definition)[]>.Default.Equals(_definitions, other._definitions);
