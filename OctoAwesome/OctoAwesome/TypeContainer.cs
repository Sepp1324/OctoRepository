...
namespace OctoAwesome
{
    public static class TypeContainer
    {
        ...
        public static void Register(Type registrar, Type type, object singelton) => instance.Register(registrar, type, singelton);
       
        public static void Register<T>(T singelton) where T : class => instance.Register(singelton);
       
        public static void Register<TRegistrar, T>(object singelton) where T : class => instance.Register<TRegistrar, T>(singelton);
