...
namespace OctoAwesome
{
    ...
    public struct Index3 : IEquatable<Index3>
    {
        ...
        {
            return new(i1.X + i2.X, i1.Y + i2.Y, i1.Z + i2.Z);
        }
        ...
        {
            return new(i1.X + i2.X, i1.Y + i2.Y, i1.Z);
        }
        ...
        {
            return new(i1.X * scale, i1.Y * scale, i1.Z * scale);
        }
        ...
        {
            return new(index.X, index.Y, index.Z);
        }
