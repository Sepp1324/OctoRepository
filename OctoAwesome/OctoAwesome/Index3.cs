...
namespace OctoAwesome
{
    ...
    public struct Index3 : IEquatable<Index3>
    {
        ...
        /// <param name="size">Normalisierungsgröße</param>
        /// <returns>Entfernung</returns>
        public Index2 ShortestDistanceXY(Index2 destination, Index2 size) => new(ShortestDistanceX(destination.X, size.X), ShortestDistanceY(destination.Y, size.Y));
        ...
        /// <param name="size">Normalisierungsgröße</param>
        /// <returns>Entfernung</returns>
        public Index3 ShortestDistanceXY(Index3 destination, Index3 size) => new(ShortestDistanceX(destination.X, size.X), ShortestDistanceY(destination.Y, size.Y), destination.Z - Z);
        ...
        /// <param name="size">Normalisierungsgröße</param>
        /// <returns>Entfernung</returns>
        public Index3 ShortestDistanceXY(Index3 destination, Index2 size) => new(ShortestDistanceX(destination.X, size.X), ShortestDistanceY(destination.Y, size.Y), destination.Z - Z);
        ...
        /// <param name="size">Normalisierungsgröße</param>
        /// <returns>Entfernung</returns>
        public Index3 ShortestDistanceXYZ(Index3 destination, Index3 size) => new(ShortestDistanceX(destination.X, size.X), ShortestDistanceY(destination.Y, size.Y), ShortestDistanceZ(destination.Z, size.Z));
        ...
        /// <returns></returns>
        public static Index3 operator +(Index3 i1, Index3 i2) => new(i1.X + i2.X, i1.Y + i2.Y, i1.Z + i2.Z);
        ...
        /// <returns></returns>
        public static Index3 operator +(Index3 i1, Index2 i2) => new(i1.X + i2.X, i1.Y + i2.Y, i1.Z);
        ...
        /// <returns></returns>
        public static Index3 operator *(Index3 i1, int scale) => new(i1.X * scale, i1.Y * scale, i1.Z * scale);
        ...
        public bool Equals(Index3 other) => other.X == X && other.Y == Y && other.Z == Z;
        ...
        ///     Null-Index
        /// </summary>
        public static Index3 Zero => new(0, 0, 0);

        /// <summary>
        ///     Gibts Index(1,1,1) zurück
        /// </summary>
        public static Index3 One => new(1, 1, 1);

        /// <summary>
        ///     Einheitsindex für X
        /// </summary>
        public static Index3 UnitX => new(1, 0, 0);

        /// <summary>
        ///     Einheitsindex für Y
        /// </summary>
        public static Index3 UnitY => new(0, 1, 0);

        /// <summary>
        ///     Einheitsindex für Z
        /// </summary>
        public static Index3 UnitZ => new(0, 0, 1);
    }
}