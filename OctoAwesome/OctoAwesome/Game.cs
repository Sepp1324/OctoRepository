...
namespace OctoAwesome
{
    public class Game
    {
        ...
        public void Update(TimeSpan frameTime )
        {
            ...
            //Position = new Point(Position.X + (int)(Velocity.X * frameTime.TotalSeconds), Position.Y + (int)(Velocity.Y * frameTime.TotalSeconds));
            ...
            {
                //Velocity = new Point(Velocity.X, -Velocity.Y);
                Position = new Point(PlaygroundSize.X, Position.Y - 100);
            }
        }
    }
}
