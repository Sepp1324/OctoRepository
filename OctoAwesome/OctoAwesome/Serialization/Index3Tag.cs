...
namespace OctoAwesome.Serialization
{
    public struct Index3Tag : ITag, IEquatable<Index3Tag>
    {
        ...
        public void FromBytes(byte[] array, int startIndex) => Index = new Index3(BitConverter.ToInt32(array, startIndex), BitConverter.ToInt32(array, startIndex + sizeof(int)), BitConverter.ToInt32(array, startIndex + sizeof(int) + sizeof(int)));
