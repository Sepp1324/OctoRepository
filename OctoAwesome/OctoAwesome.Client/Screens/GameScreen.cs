...
namespace OctoAwesome.Client.Screens
{
    internal sealed class GameScreen : Screen
    {
        ...
        public GameScreen(ScreenComponent manager) : base(manager)
        {
            ...
            _scene = new SceneControl(manager) {HorizontalAlignment = HorizontalAlignment.Stretch, VerticalAlignment = VerticalAlignment.Stretch};
            Controls.Add(_scene);

            _debug = new DebugControl(manager) {HorizontalAlignment = HorizontalAlignment.Stretch, VerticalAlignment = VerticalAlignment.Stretch, Visible = false};
            Controls.Add(_debug);
            ...
            _toolbar = new ToolbarControl(manager) {HorizontalAlignment = HorizontalAlignment.Stretch, VerticalAlignment = VerticalAlignment.Bottom, Height = 100};
            ...
            _crosshair = new CrosshairControl(manager) {HorizontalAlignment = HorizontalAlignment.Center, VerticalAlignment = VerticalAlignment.Center, Width = 8, Height = 8};
